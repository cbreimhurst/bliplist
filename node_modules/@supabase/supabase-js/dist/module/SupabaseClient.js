...
export default class SupabaseClient {
        ...
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!openSubscriptions) {
                    let { error } = yield this.realtime.disconnect();
                    if (error)
    ...
    _initSupabaseAuthClient(settings) {
    ...
    _getAuthHeaders() {
        var _a, _b;
        let headers = {};
        let authBearer = (_b = (_a = this.auth.session()) === null || _a === void 0 ? void 0 : _a.access_token) !== null && _b !== void 0 ? _b : this.supabaseKey;
