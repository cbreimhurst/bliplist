...
export default class GoTrueApi {
    ...
    signInWithEmail(email, password) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield post(`${this.url}/token?grant_type=password`, { email, password }, { headers: this.headers });
                return { data, error: null };
            }
            catch (error) {
                return { data: null, error };
    ...
    inviteUserByEmail(email) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield post(`${this.url}/invite`, { email }, { headers: this.headers });
                return { data, error: null };
            }
            catch (error) {
                return { data: null, error };
    ...
    resetPasswordForEmail(email) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield post(`${this.url}/recover`, { email }, { headers: this.headers });
                return { data, error: null };
            }
            catch (error) {
                return { data: null, error };
    ...
    signOut(jwt) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield post(`${this.url}/logout`, {}, { headers, noResolveJson: true });
                return { error: null };
            }
            catch (error) {
                return { error };
    ...
    refreshAccessToken(refreshToken) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let data = yield post(`${this.url}/token?grant_type=refresh_token`, { refresh_token: refreshToken }, { headers: this.headers });
                return { data, error: null };
            }
            catch (error) {
                return { data: null, error };
